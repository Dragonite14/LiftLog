...
export default function popupModal ({ dayClicked, daysExercises, setOpenModal }) {
    ...
    const modalExercises = exercises.map(el=>{
        ...
        <div className="modal-exercise">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square edit-exercise" viewBox="0 0 16 16"
    ...
    return (
    <div id='popup-modal'>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x-lg close-model" viewBox="0 0 16 16"
